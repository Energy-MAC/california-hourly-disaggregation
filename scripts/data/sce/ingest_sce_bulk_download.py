...
Usage examples
--------------
  python scripts/data/sce/ingest_sce_bulk_download.py path/to/download.zip
  python scripts/data/sce/ingest_sce_bulk_download.py path/to/download.csv
  python scripts/data/sce/ingest_sce_bulk_download.py path/to/download.zip --compare
"""
