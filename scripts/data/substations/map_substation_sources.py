...
Outputs
-------
  data/figures/substation_maps/map_pge_source_overlap.png
  data/figures/substation_maps/map_sce_source_overlap.png
  data/figures/substation_maps/map_sdge_source_overlap.png
  data/figures/substation_maps/map_cleaned_vs_basin.png
  data/figures/substation_maps/map_basin_coverage.png

Usage
-----
  python scripts/data/substations/map_substation_sources.py
  python scripts/data/substations/map_substation_sources.py --util pge
  python scripts/data/substations/map_substation_sources.py --util cleaned
  python scripts/data/substations/map_substation_sources.py --util basin
"""
...
FIGS_MAPS = FIGS / "substation_maps"
FIGS.mkdir(parents=True, exist_ok=True)
FIGS_MAPS.mkdir(parents=True, exist_ok=True)
...
def map_pge() -> None:
    ...
    _make_iou_fig(
        ...
        out_path=FIGS_MAPS / "map_pge_source_overlap.png",
    )
...
def map_sce() -> None:
    ...
    _make_iou_fig(
        ...
        out_path=FIGS_MAPS / "map_sce_source_overlap.png",
        legend_fontsize=6,
    )
...
def map_sdge() -> None:
    ...
    _make_iou_fig(
        ...
        out_path=FIGS_MAPS / "map_sdge_source_overlap.png",
        figsize=(14, 7),
    )
...
def map_cleaned_vs_basin() -> None:
    ...
    out = FIGS_MAPS / "map_cleaned_vs_basin.png"
...
def map_basin_coverage() -> None:
    ...
    out = FIGS_MAPS / "map_basin_coverage.png"
    fig.savefig(out, dpi=150)
    plt.close(fig)
