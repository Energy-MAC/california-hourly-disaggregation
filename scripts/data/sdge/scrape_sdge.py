...
--------------------------------------
python scripts/data/sdge/scrape_sdge.py discover
python scripts/data/sdge/scrape_sdge.py discover --service ICA_MAP_PROD_Substations_VW
python scripts/data/sdge/scrape_sdge.py discover --service ICA_MAP_PROD_Substations_VW --layer-id 0
