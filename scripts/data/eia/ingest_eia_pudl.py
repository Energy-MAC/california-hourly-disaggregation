...
Two parquet files are written (both filtered to CA-relevant BAs):
  out_eia930__hourly_operations_CA8.parquet
...
Usage
-----
python scripts/data/eia/ingest_eia_pudl.py
python scripts/data/eia/ingest_eia_pudl.py --ops-only
python scripts/data/eia/ingest_eia_pudl.py --bas BANC CISO LDWP
"""
