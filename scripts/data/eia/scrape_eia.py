...
python scripts/data/eia/scrape_eia.py rto-region --start 2023-01-01 --end 2023-12-31

# All interchange flows, full history
python scripts/data/eia/scrape_eia.py rto-interchange --start 2020-01-01 --end 2024-12-31
...
# Allow running as `python scripts/data/eia/scrape_eia.py` from the repo root
