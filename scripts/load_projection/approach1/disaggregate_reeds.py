...
-----
  ...
  # Historic only
  python scripts/load_projection/approach1/disaggregate_reeds.py --mode historic

  # Projected only, also write the monthly parquet
  python scripts/load_projection/approach1/disaggregate_reeds.py --mode projected --save-output

  # Custom weight column and level
  python scripts/load_projection/approach1/disaggregate_reeds.py --weight-col min_load --weight-level monthly

  # Full run with large output saved
  python scripts/load_projection/approach1/disaggregate_reeds.py --mode both --weight-col max_load --weight-level monthhour --save-output
