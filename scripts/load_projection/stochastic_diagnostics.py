...
Usage:
  python scripts/load_projection/stochastic_diagnostics.py
  python scripts/load_projection/stochastic_diagnostics.py --year-start 2022 --year-end 2024
  python scripts/load_projection/stochastic_diagnostics.py --f 0.70,0.85
"""
...
def write_hygiene_report(h: dict) -> Path:
    ...
    lines = [
        ...
        "",
        "Generated by `scripts/load_projection/stochastic_diagnostics.py`. Covers the",
